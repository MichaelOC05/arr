# Generated by Django 4.0.3 on 2022-09-15 21:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_rating', models.FloatField(blank=True, null=True)),
                ('plot_rating', models.FloatField(blank=True, null=True)),
                ('char_rating', models.FloatField(blank=True, null=True)),
                ('setting_rating', models.FloatField(blank=True, null=True)),
                ('add_on_rating', models.FloatField(blank=True, null=True)),
                ('removal_rating', models.FloatField(blank=True, null=True)),
                ('rubric_rating', models.FloatField(blank=True, null=True)),
                ('admin_rating', models.FloatField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ReviewModel',
            fields=[
                ...
                ('movie_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review_models', to='monolith_rest.movieinformationmodel')),
                ('reviewer_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reviews_model', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
