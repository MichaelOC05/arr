            ...
            <>
                ...
                <div className="col-lg-10 mx-auto">
                    <p className="lead mb-4">
                        ...
                        However, we find these adaptations to be a bit...inaccurate. Our team decided that there should be a rating system for 
                ...
                <h3 className="h3">The Base Rating and Rubric Rating:</h3>
                    <p className="lead mb-4">
                        ...
                        will then be calculated into an average score. Our team uses the same rubric when rating, and we believe it gives a 
                        more accurate result. These categories are listed below.
                    </p>
                <h3 className="h3">The Plot Rating:</h3>
                    <p className="lead mb-4">
                        ...
                        as a whole. If the movie is accurate, it should unfold from plot point to plot point in the exact same way as the source material.
                ...
                <h3 className="h3">The Character Rating:</h3>
                    <p className="lead mb-4">
                        ...
                        on how the character compares to the original. There are many ways a character can be changed, and this goes for the main character, the villain,
                ...
                <h3 className="h3">The Setting Rating:</h3>
                    <p className="lead mb-4">
                        ...
                        times a story is brought into the present day when the story was written in the past. Maybe a location was omitted, or they changed the town 
                ...
                <h3 className="h3">The Add On Rating:</h3>
                    <p className="lead mb-4">
                        ...
                        that was listed above. Maybe the adaptation added a character, or maybe a new location, or even added an entirely new story element that 
                ...
                <h3 className="h3">You're Ready</h3>
                    <p className="lead mb-4">
                        ...
                        be added to the overall rubric score from all the other viewers while you keep, your personal score separate. If you don't see a movie you don't see on here, try creating one in "Search Movie!  So go on, write a review, or create an account
